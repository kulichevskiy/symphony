...
_REVIEW_METHODS = [
    ...
    "_poll_review_run",
    # SYM-158: _poll_review_run decomposed into named sub-steps.
    "_fetch_review_pr_checks",
    "_compute_review_verdict",
    "_dispatch_review_changes_requested_fix",
...
_MERGE_METHODS = [
    ...
    "_resolve_merge_candidate",
    "_poll_completed_merge_candidate",
    "_handle_merge_candidate_pre_dispatch",
    "_merge_candidate_no_signal_readiness",
    "_gate_no_signal_merge_on_ci",
    "_dispatch_merge_candidate_decision",
