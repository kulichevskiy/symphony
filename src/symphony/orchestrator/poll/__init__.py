...
# SYM-147: the merge domain lives on `_MergeMixin`. Imported here — after every
# shared module-level constant/helper/logger above is defined — so `_merge`'s
# `from . import ...` resolves against the (still-initializing) package.
from ._merge import _MergeMixin  # noqa: E402

class Orchestrator(_MergeMixin, _SlashCommandsMixin, _DispatchMixin):
